...
class QueryTest extends SpecsMatchers with ScalaCheckMatchers {
  ...
  def testProduceCorrectSimpleQueryString {
    val q = SUser where (_.fullname eqs "jon")
  ...
  def testProduceCorrectEdisMaxQueryString {
    val q = SUser where (_.fullname eqs "holden") useQueryType("edismax")
    val qp = q.queryParams().toList
  ...
  def testProduceCorrectEdisMaxQueryStringWithMinimumMatch {
    val q = SUser where (_.fullname eqs "jason") useQueryType("edismax") minimumMatchPercent(75)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "mm" -> "75%",
                                                      "q" -> "fullname:(+\"jason\")",
  ...
  def testProduceCorrectDefaultQuery {
    val q = SVenue where (_.default eqs "bedlam coffee") useQueryType("edismax") minimumMatchPercent(75)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "mm" -> "75%",
                                                      "q" -> "(+\"bedlam coffee\")",
  ...
  def testProduceCorrectFilterQuery {
    val q = SVenue where (_.default eqs "club") filter (_.tags neqs "douchebag") useQueryType("edismax") minimumMatchPercent(75)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "mm" -> "75%",
                                                      "q" -> "(+\"club\")",
  ...
  def testProduceCorrectSimpleLimit {
    val q = SUser where (_.fullname eqs "jon") limit 250
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("q" -> "fullname:(+\"jon\")",
                                                      "start" -> "0",
  ...
  def testProduceCorrectWithQueryField {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") queryField(_.name)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "qf" -> "name",
  ...
  def testProduceCorrectWithQueryFieldAndZeroBoost {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") queryField(_.name,0)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "start" -> "0",
  ...
  def testProduceCorrectWithQueryFieldAndOneBoost {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") queryField(_.name,1)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "qf" -> "name",
  ...
  def testProduceCorrectWithQueryFieldAndBoost {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") queryField(_.name,2)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "qf" -> "name^2.0",
  ...
  def testProduceCorrectWithQueryFieldAndNonIntBoost {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") queryField(_.name,2.5)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "qf" -> "name^2.5",
  ...
  def testProduceCorrectWithPhraseBoost {
    val q = SVenue where (_.default eqs "club") useQueryType("edismax") phraseBoost(_.name,2.5)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"club\")",
                                                      "pf" -> "name^2.5",
  ...
  def testProduceCorrectWithRange {
    val q = SVenue where (_.default inRange("a","z")) useQueryType("edismax")
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+[a to z])",
                                                      "start" -> "0",
  ...
  def testProduceCorrectWithDateRange {
    ...
    val q = SEvent where (_.start_time inRange(d1, d2))
    val qp = q.queryParams().toList
  ...
  @Test
  def testFieldQuery {
    val q = SVenue where (_.default eqs "bedlam coffee") useQueryType("edismax") fetchField (_.name) fetchField(_.address)
    val qp = q.queryParams().toList
    Assert.assertEquals(qp.sortWith(_._1 > _._1),List("defType" -> "edismax",
                                                      "q" -> "(+\"bedlam coffee\")",
                                                      "start" -> "0",
  ...
  def testAutoComplexQuery1 {
    ...
    val q = SVenue where (_.default contains lols) useQueryType("edismax") phraseBoost(_.text,1) phraseBoost(_.name,200) phraseBoost(_.aliases,25) queryField(_.text) queryField(_.ngram_name,0.2)
    val qp = q.queryParams().toList
  ...
  def testAutoComplexQuery2 {
    val lols="holden's hobohut"
    val q = SVenue where (_.default contains lols) useQueryType("edismax") phraseBoost(_.text,1) phraseBoost(_.name,200) phraseBoost(_.aliases,25) queryField(_.text) queryField(_.ngram_name,0.2) queryField(_.tags,0.01)
    val qp = q.queryParams().toList
    val expected = List("defType" -> "edismax",
                        "q" -> "(holden's hobohut)",
                        "start" -> "0",
  ...
  def testAutoComplexQuery3 {
    ...
    val q = SVenue where (_.default contains lols) useQueryType("edismax") phraseBoost(_.text,1) phraseBoost(_.name,200) phraseBoost(_.aliases,25) queryField(_.text) queryField(_.ngram_name,0.2) queryField(_.tags,0.01) tieBreaker(0.2)
    val qp = q.queryParams().toList
    val expected = List("defType" -> "edismax",
                        "q" -> "(holden's hobohut)",
                        "start" -> "0",
  ...
  def testAutoComplexQuery4 {
    ...
    val geoLat = 37.7519528215759
    val geoLong = -122.42086887359619
    val q = SVenue where (_.default contains lols) useQueryType("edismax") phraseBoost(_.text,1) phraseBoost(_.name,200) phraseBoost(_.aliases,25) queryField(_.text) queryField(_.ngram_name,0.2) queryField(_.tags,0.01) tieBreaker(0.2) boostField(_.decayedPopularity1) boostField("recip(sqedist(%s,%s,lat,lng),1,5000,1)".format(geoLat,geoLong))
    val qp = q.queryParams().toList
    val expected = List("defType" -> "edismax",
                        "q" -> "(holden's hobohut)",
                        "start" -> "0",
...
//                        expected.sortWith(((x,y) => (x._1+x._2) > (y._1+y._2))))
  ...
  def sortwithPopular {
    ...
    val q = SVenue where (_.meta_categories in mcat) useQueryType("edismax") orderDesc(_.decayedPopularity1)
    val qp = q.queryParams().toList
  ...
  def sortwithPopularandLimit {
    ...
    val geoLong = -122.42086887359619
    val mcat = List("Coffee", "Delicious", "pirates")
    val q = SVenue where (_.meta_categories in mcat) useQueryType("edismax") orderDesc(_.decayedPopularity1) limit(200)
    val qp = q.queryParams().toList
    val cat_str = mcat.map((x=>"\""+x+"\"")).mkString(" OR ")
    val expected = List("defType" -> "edismax",
                        "sort" -> "decayedPopularity1 desc",
  ...
  def sortwithPopularandLimitandCat {
    ...
    val geoLong = -122.42086887359619
    val cat = List("test")
    val q = SVenue where (_.category_ids in cat) useQueryType("edismax") orderDesc(_.decayedPopularity1) limit(200)
    val qp = q.queryParams().toList
  ...
  def sortwithPopularandLimitandOr {
    ...
    val mcat = List("Coffee", "Delicious", "pirates")
    val cat = List("test")
    val q = SVenue where (_.category_ids in cat ) or (_.meta_categories in mcat)  useQueryType("edismax") orderDesc(_.decayedPopularity1) limit(200)
    val qp = q.queryParams().toList
  ...
  def sortwithPopularandAll {
    ...
    val geoLat = 37.7519528215759
    val geoLong = -122.42086887359619
    val q = SVenue where (_.metall any) useQueryType("edismax") orderDesc(_.decayedPopularity1)
    val qp = q.queryParams().toList
    val expected = List("defType" -> "edismax",
                        "sort" -> "decayedPopularity1 desc",
                        "q" -> "*:*",
